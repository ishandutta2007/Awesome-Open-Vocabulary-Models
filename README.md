...
| **Traditional Zero-Shot Era** | ~2018–2021 | Evaluated models on unseen classes by mapping visual features onto hand-crafted intermediate attribute vectors or static word embeddings (like Word2Vec). Suffered from poor localization and low accuracy on complex, real-world novel classes. | 2018 | [Zero-Shot Learning — A Comprehensive Evaluation of the Good, the Bad and the Ugly](https://arxiv.org/abs/1707.00600) |
